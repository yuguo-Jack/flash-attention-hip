...
struct GridwiseMultiHeadFlashAttentionInfer_Xdl_CShuffle_V2
{
                               ...
                               const C0MatrixMask& c0_matrix_mask)
    {
        ...
        constexpr index_t Gemm1KPack =
            MfmaSelector<FloatAB, MPerXdl, NPerXdl>::selected_mfma.group_size * MfmaSelector<FloatAB, MPerXdl, NPerXdl>::selected_mfma.num_groups_per_blk;
        ...
        do
        {
                   ...
                   m_block_data_idx_on_grid, n_block_data_idx_on_grid, MPerBlock, NPerBlock))
            {
                b_blockwise_copy.MoveSrcSliceWindow(b_grid_desc_bk0_n_bk1,
                                    make_multi_index(0, NPerBlock, 0)); // step N
                
                b1_blockwise_copy.MoveSrcSliceWindow(b1_grid_desc_bk0_n_bk1,
                                    make_multi_index(num_gemm1_k_block_inner_loop*Gemm1KPerBlock, 0, 1));
                continue;
            }
            // gemm0
            ...
            // wangaq debug
            // if(blockIdx.x == 0) {
            //     printf("S tid:%d index:%d %6.4f %6.4f %6.4f %6.4f "
            //     "%6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f\n", threadIdx.x, gemm1_k_block_outer_index,
            //     acc_thread_buf[Number<0>{}],  acc_thread_buf[Number<1>{}],
            //     acc_thread_buf[Number<2>{}],  acc_thread_buf[Number<3>{}],
            //     acc_thread_buf[Number<4>{}],  acc_thread_buf[Number<5>{}],
            //     acc_thread_buf[Number<6>{}],  acc_thread_buf[Number<7>{}],
            //     acc_thread_buf[Number<8>{}],  acc_thread_buf[Number<9>{}],
            //     acc_thread_buf[Number<10>{}], acc_thread_buf[Number<11>{}],
            //     acc_thread_buf[Number<12>{}], acc_thread_buf[Number<13>{}],
            //     acc_thread_buf[Number<14>{}], acc_thread_buf[Number<15>{}]);
            // }
            ...
            // wangaq debug
            // if(blockIdx.x == 0) {
            //     printf("P tid:%d index:%d %6.4f %6.4f %6.4f %6.4f "
            //     "%6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f\n", threadIdx.x, gemm1_k_block_outer_index,
            //     acc_thread_buf[Number<0>{}],  acc_thread_buf[Number<1>{}],
            //     acc_thread_buf[Number<2>{}],  acc_thread_buf[Number<3>{}],
            //     acc_thread_buf[Number<4>{}],  acc_thread_buf[Number<5>{}],
            ...
            // gemm1
            {
                ...
                if constexpr(num_gemm1_k_block_inner_loop > 1)
                {
                    static_for<0, num_gemm1_k_block_inner_loop - 1, 1>{}([&](auto i) {
                        ...
                        gemm1_blockwise_gemm.RunWithStride(a1_thread_buf, b1_block_buf, acc1_thread_buf);
            ...
            // wangaq debug
            // if(blockIdx.x == 0) {
            //     printf("acc1 tid:%d index:%d %6.4f %6.4f %6.4f %6.4f "
            //     "%6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f\n", threadIdx.x, gemm1_k_block_outer_index,
            //     acc1_thread_buf[Number<0>{}],  acc1_thread_buf[Number<1>{}],
            //     acc1_thread_buf[Number<2>{}],  acc1_thread_buf[Number<3>{}],
            //     acc1_thread_buf[Number<4>{}],  acc1_thread_buf[Number<5>{}],
            //     acc1_thread_buf[Number<6>{}],  acc1_thread_buf[Number<7>{}],
            //     acc1_thread_buf[Number<8>{}],  acc1_thread_buf[Number<9>{}],
            //     acc1_thread_buf[Number<10>{}], acc1_thread_buf[Number<11>{}],
            //     acc1_thread_buf[Number<12>{}], acc1_thread_buf[Number<13>{}],
            //     acc1_thread_buf[Number<14>{}], acc1_thread_buf[Number<15>{}]);
            // }
