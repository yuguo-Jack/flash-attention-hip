...
#include "ck/tensor_operation/gpu/grid/gridwise_batched_mha_infer_xdl_cshuffle_v2.hpp"
...
#endif
        kernel_batched_multiple_head_flash_attention_infer_v2(
...
struct DeviceBatchedMultiheadAttentionInfer_Xdl_CShuffle_V2
                                                  ...
                                                  MaskingSpec>
{
    ...
    using DeviceOp = DeviceBatchedMultiheadAttentionInfer_Xdl_CShuffle_V2;
    ...
    constexpr static auto make_MaskOutPredicate()
    {
        ...
        else if constexpr(MaskingSpec == MaskingSpecialization::MaskUpperTriangleFromTopLeftWithPrefix)
        {
            return MaskUpperTriangleFromTopLeftWithPrefixPredicate{};
        }
    }
    ...
    using GridwiseGemm = GridwiseMultiHeadFlashAttentionInfer_Xdl_CShuffle_V2<
    ...
    struct Invoker : public BaseInvoker
    {
        ...
        float Run(const Argument& arg, const StreamConfig& stream_config = StreamConfig{})
        {
            ...
            auto launch_kernel = [&](auto has_main_k_block_loop_) {
                const auto kernel = kernel_batched_multiple_head_flash_attention_infer_v2<
                    GridwiseGemm,
    ...
    std::string GetTypeString() const override
    {
        ...
        // clang-format off
        str << "DeviceBatchedMultiheadAttentionInfer_Xdl_CShuffle_V2"
            << "<"
            << BlockSize << ", "
            << MPerBlock << ", "
            << NPerBlock << ", "
